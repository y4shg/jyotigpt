...
class ERROR_MESSAGES(str, Enum):
    ...
    EXISTING_USERS = "You can't turn off authentication because there are existing users. If you want to disable JYOTIGPT_AUTH, make sure your web interface doesn't have any existing users and is a fresh installation."
    ...
    OLLAMA_NOT_FOUND = "JYOTIGPT could not connect to Ollama"
