...
- feat: add haptic feedback for sidebar interactions
- feat: add haptic feedback for message send
- feat: add haptic feedback for button press
...
- feat: call button color fix
- feat: introduce Instrument Serif font to chat placeholders, fix dark mode button colors, and disable package deletion workflow.
