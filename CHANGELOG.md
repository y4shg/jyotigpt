...
- Update UI layout shell (sidebar, navbar, and app frame) to a modern red-forward design with improved light and dark themes
- Introduce semantic Tailwind theme tokens for backgrounds, surfaces, borders, and primary red accents
- Wire in Open Sauce Sans as the primary brand/UI font and adjust typography utilities for consistency
