<script lang="ts">
	...
	import DragGhost from '$shared/components/DragGhost.svelte';
	import Check from '$shared/icons/Check.svelte';
	import XMark from '$shared/icons/XMark.svelte';
	import Document from '$shared/icons/Document.svelte';
	...
	{:else}
		...
		>
			<div class=" flex self-center flex-1 w-full">
				<div dir="auto" class="text-left self-center overflow-hidden w-full h-[20px] font-normal">
					{title}
				</div>
			</div>
		</a>
