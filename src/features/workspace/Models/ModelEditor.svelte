<script lang="ts">
	...
	import Knowledge from '$features/workspace/Models/Knowledge.svelte';
	import ToolsSelector from '$features/workspace/Models/ToolsSelector.svelte';
	import FiltersSelector from '$features/workspace/Models/FiltersSelector.svelte';
