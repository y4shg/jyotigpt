<script lang="ts">
	...
	import BarsArrowUp from '$shared/icons/BarsArrowUp.svelte';
	import FolderOpen from '$shared/icons/FolderOpen.svelte';
	import ArrowPath from '$shared/icons/ArrowPath.svelte';
