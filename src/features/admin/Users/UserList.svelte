<script>
	...
	import EditUserModal from '$features/admin/Users/UserList/EditUserModal.svelte';
	import UserChatsModal from '$features/admin/Users/UserList/UserChatsModal.svelte';
	import AddUserModal from '$features/admin/Users/UserList/AddUserModal.svelte';
	...
	import About from '$features/chat/Settings/About.svelte';
					...
					<td class="px-3 py-1 font-medium text-gray-900 dark:text-white w-max">
						<div class="flex flex-row w-max">
							<img
								...
								src={user.profile_image_url.startsWith(JYOTIGPT_BASE_URL) ||
