<script lang="ts">
	...
	import Menu from '$shared/layout/Navbar/Menu.svelte';
	import UserMenu from '$shared/layout/Sidebar/UserMenu.svelte';
	import SidebarIcon from '$shared/icons/SidebarIcon.svelte';
	import ChatPulser from '$shared/icons/ChatPulser.svelte';

	import PencilSquare from '$shared/icons/PencilSquare.svelte';
